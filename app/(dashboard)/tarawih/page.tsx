...
import { Moon, Calendar, Flame, CheckCircle } from "lucide-react"
...
export default async function TarawihPage() {
  ...
  // Format Header (Menggunakan logic Maghrib dari ramadhan-time.ts)
  ...
  const days = Array.from({ length: 30 }, (_, i) => {
      ...
      // Contoh: Jika Puasa 17 Feb, maka Tarawih Malam 1 adalah 16 Feb
      ...
      // 3. LOGIKA LOCK BY TIME (PUKUL 20:00)
      // Kunci terbuka hanya jika waktu sekarang >= Pukul 20:00 pada tanggal tersebut
      ...
      return {
          ...
          isLocked: isLocked, // Status lock real-time
      }
  })
      ...
      <div className="bg-linear-to-br from-violet-600 to-indigo-900 rounded-2xl p-5 md:p-8 text-white shadow-xl relative overflow-hidden flex flex-col">
        ...
        <div className="relative z-10">
            <div className="mb-6">
                ...
                <p className="text-violet-200 text-xs md:text-sm mt-1 leading-snug max-w-[90%]">
                    Raih sukses ramadhan dengan perbanyak sholat malam.
                    <span className="block mt-1 text-violet-300 text-[10px] italic opacity-80">(Ceklis terbuka setiap pukul 20.00 WIB)</span>
                </p>
            </div>
